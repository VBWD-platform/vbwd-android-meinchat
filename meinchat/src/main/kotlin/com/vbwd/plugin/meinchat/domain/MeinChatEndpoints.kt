...
internal object MeinChatEndpoints {
    ...
    fun searchNickname(query: String): String = "/nickname/search?q=${URLEncoder.encode(query, Charsets.UTF_8.name())}"
    ...
    fun messagesPage(
        ...
        before: String,
        limit: Int,
    ): String = "/messaging/conversations/$convId/messages?before=$before&limit=$limit"
